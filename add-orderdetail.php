<?php
   ...
   if($_POST) // when u enter the product details that informtaion have to store at server side this code is for that
   {
    ...
    $qurey=mysqli_query($connection, "insert into  orders_tbl(order_detail_id,order_id,product_id,amount) values('{$order_detail_id}','{$order_id}','{$product_id}','{$amount}')") ;
                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                        ...
                                        <form  method="post" class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <!-- <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-email" class=" form-control-label">order_detail_id	</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="hf-email" name="	order_id" placeholder="Enter the order_detail_id	" Required class="form-control" >                  
                                                </div>
                                            </div> -->
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <button type="butoon" onclick="window.location='display-orderdetail.php'; " class="btn btn-info btn-sm">
