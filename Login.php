  ...
  <div class="container bg-secondary" >
    ...
    <form id="myform" class="box" method="post">
      ...
      <h5 style="margin-top: 30px;"><br>Sign in to your account.</h5>
        <input type="text" name="user_mobile" id="user_mobile" placeholder="Phone no." autocomplete="on" onchange="phonenumber(this)" style="margin-top: 30px;">
        <p id="validnum" class="message"></p>
        <i class="typcn typcn-eye" id="eye"></i>
        <input type="password" name="user_password" placeholder="Passsword" id="user_password" autocomplete="on">
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $username = $_POST["user_mobile"];
    $password = $_POST["user_password"]; 
    
     
    // $sql = "Select * from users where username='$username' AND password='$password'";
    $sql = "Select * from user_type where phone_no='$username' and password='$password';";
