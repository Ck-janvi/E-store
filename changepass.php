...
?>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-7">
            <h5 class="position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">Change Password</span></h5>
                <div class="bg-light p-30 mb-5">
                    <div class="">
                        ...
                        <div class="col-lg-7 text-black" style="margin-top:20px">
                            ...
                            <input class="form-control" name="user_pass" type="password" placeholder="Enter New Password">
                            <p id="id3" class="message"></p>
                        </div>
                        
                        <div class="col-lg-7 text-black" style="margin-top:20px">
                            <label>Confirm Password</label>
                            <input class="form-control" name="user_pass1" type="password" placeholder="Re-enter New Password">
                            <p id="id4" class="message"></p>
                        </div>
                        <div style="margin-top: 30px; display:flex;justify-content:center;">
                        <button class="btn btn-block btn-primary font-weight-bold py-3" style="height: 50px; width:150px">Submit</button>
                        </div>
                        </form>
                        <script>
