...
$p_query = ("SELECT * FROM product_tbl A left join product_detail_tbl B on A.product_id=B.product_id WHERE A.product_id='{$pid}'");

$prod_query = mysqli_query($connection,$p_query);

// $count = mysqli_num_rows($prod_query);
// if($count<1){
//     header("location:productlist.php");
// }

$product_detail = mysqli_fetch_array($prod_query);
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="./img/<?php echo $product_detail['image_part']?>" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    <h3 class="a-size"><?php echo $product_detail['product_name'] ?></h3>
                    ...
                    <hr>
                    <h3 class="font-weight-semi-bold mb-4 a-size">Rs. <?php echo $product_detail['price'] ?>.00</h3>
                    <p class="mb-4"><?php echo $product_detail['product_specification'] ?></p>
                    <div class="d-flex mb-3">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <input type="number" class="form-control bg-secondary border-0 text-center" name="qty" value="1" min="1" max="20">
                            <div class="input-group-btn">
