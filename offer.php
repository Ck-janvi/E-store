<?php
   ...
   if($_POST) // when u enter the product details that informtaion have to store at server side this code is for that
   {
    ...
    $qurey=mysqli_query($connection, "insert into  orders_tbl(offer_id,product_id,offer_type,offer_details) values('{$offer_id}','{$product_id}','{$offer_type}','{$offer_details}')") ;
                                        ...
                                        <form  method="post" class="form-horizontal" enctype="multipart/form-data">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-email" class=" form-control-label">offer_id</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="hf-email" name="	offer_id" placeholder="Enter offer_id" Required class="form-control" >                  
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-email" class=" form-control-label">offer_type</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-email" class=" form-control-label">offer_details</label>
                                                </div>
                                                <div class="col-12 col-md-9">
