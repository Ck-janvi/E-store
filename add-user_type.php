<?php
   ...
   if($_POST) // when u enter the product details that informtaion have to store at server side this code is for that
   {
    ...
    $qurey=mysqli_query($connection, "insert into  user_type_tbl(user_type_name) values('{$u_type_name}')");
...
<!--                                             
                                           <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="hf-email" class=" form-control-label">u_type_id</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="hf-email" name="u_type_id" placeholder="Enter the u_type_id" Required class="form-control" >                  
                                                </div>
                                            </div> -->
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <button type="butoon" onclick="window.location='display-user_type.php'; " class="btn btn-info btn-sm">
