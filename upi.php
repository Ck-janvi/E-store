...
?>
    ...
    <div class="container-fluid">
        <div class="row px-xl-5" style="display: flex; justify-content:center;">
            ...
            <div class="col-lg-6">
                <h5 class="position-relative text-uppercase mb-3"><span class="bg-secondary pr-3">UPI Payment</span></h5>
                <div class="bg-light p-30 mb-5">
                    <div class="row">
                        <div class="col-md-10 form-group text-black">
                            <label>UPI ID</label>
                            <input class="form-control" type="text" placeholder="Enter UPI ID">
                        </div>
                        <div class="col-md-10 form-group text-black">
                            <label>Name</label>
